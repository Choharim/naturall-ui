...
import {
  ...
  yI,
  zr
} from "./chunk-GALXU5PL.js";
import {
  require_core_events
} from "./chunk-3T3HEUF2.js";
import {
  require_client
} from "./chunk-IXLYPMIF.js";
import "./chunk-M5D3ZKO2.js";
import "./chunk-MWDTHHI2.js";
import {
  gt,
  yn
} from "./chunk-QVQIN3G6.js";
import {
  require_react
} from "./chunk-XAR6OMAQ.js";
...
// .yarn/__virtual__/@storybook-addon-docs-virtual-78a22a76e9/3/.yarn/berry/cache/@storybook-addon-docs-npm-8.4.7-78c31ff38c-10c0.zip/node_modules/@storybook/addon-docs/dist/chunk-NUUEMKO5.mjs
var import_react2 = __toESM(require_react(), 1);

// .yarn/__virtual__/@storybook-blocks-virtual-af01732697/3/.yarn/berry/cache/@storybook-blocks-npm-8.4.7-207aaa0972-10c0.zip/node_modules/@storybook/blocks/dist/index.mjs
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-JLM56HVV.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-F6OSRLHC-EVE5RNLB.js"));
...
// .yarn/__virtual__/@storybook-react-dom-shim-virtual-6197973fee/3/.yarn/berry/cache/@storybook-react-dom-shim-npm-8.4.7-4a5a6f9b3e-10c0.zip/node_modules/@storybook/react-dom-shim/dist/react-18.mjs
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-3B2HSY2D.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=DocsRenderer-CFRXHY34-UGIKRZWN.js.map
